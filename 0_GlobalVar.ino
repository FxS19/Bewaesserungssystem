...
#define WATERING_POINTS_ADRESS 1 // 8 Bit
#define OK_SOIL_MOISTURE_ADRESS 3 // 8 Bit
#define MAIN_PUMP_SPEED_ADRESS 4 // 8 Bit
#define BASE_ML_PER_WATERING_POINT_ADRESS 5 // 16Bit
